...
const deletePost = async (req, res) => {
  try {
    ...
    if (curPost.owner.toString() !== curUserId) {
    ...
    await curPost.deleteOne({ _id: postId });
...
module.exports = { createPost, likeAndUnlikePost, updatePost, deletePost };
